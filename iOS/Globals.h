...
enum {BTN_A=0,BTN_B,BTN_Y,BTN_X,BTN_L1,BTN_R1,BTN_A_Y,BTN_A_X,BTN_B_Y,BTN_B_X,BTN_SELECT,BTN_START,BTN_EXIT,BTN_OPTION,BTN_SELECT2,BTN_START2,BTN_STICK,NUM_BUTTONS};
